...
## [0.7.0](https://github.com/metzenseifner/sismatic/compare/v0.6.1...v0.7.0) - 2026-09-17

### Added

- [**breaking**] core changes to support disabled fields

## [0.6.1](https://github.com/metzenseifner/sismatic/compare/v0.6.0...v0.6.1) - 2026-09-07

### Added

- add support for dynamic configuration changes and kubernetes Co… ([#54](https://github.com/metzenseifner/sismatic/pull/54))
- add support for dynamic configuration changes and kubernetes ConfigMap.
...
- [**breaking**] add group sync state to groups as dededicated state
- add endpoint to query over entire fleet
