...
instruction_catalog! {
    ...
    pub enum Query {
        ...
        Language { name: "LANGUAGE", aliases:[], doc: "Dublin Core Language identifier"},
        Publisher { name:"PUBLISHER", aliases: [], doc: "Dublin Core Publisher identifier"},
...
impl Query {
    ...
    pub fn instruction(self) -> Instruction {
        ...
        let (payload, parser): (String, ParseFn) = match self {
            ...
            Language => (esc_rcdr("M7"), plain_text()),
            Publisher => (esc_rcdr("M8"), plain_text()),
